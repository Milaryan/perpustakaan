<div class="demo-option-container">
    ...
    <div class="brook__toolbar">
        <div class="inner">
            <a class="hint--bounce hint--left hint--black primary-color-hover-important" href="{{ route('createuser') }}" aria-label="Tambah User">
                <i class="fa fa-user-plus" aria-hidden="true"></i>
            </a>
            <a class="hint--bounce hint--left hint--black primary-color-hover-important" href="{{ route('createbuku') }}" aria-label="Tambah Buku">
                <i class="fa fa-book" aria-hidden="true"></i>
            </a>
            <a class="hint--bounce hint--left hint--black primary-color-hover-important" href="{{ route('createkategori') }}" aria-label="Tambah Kategori">
                <i class="fa fa-plus-circle" aria-hidden="true"></i>
            </a>
            <a class="hint--bounce hint--left hint--black primary-color-hover-important" href="{{ route('createtransaksi') }}" aria-label="Tambah Transaksi">
